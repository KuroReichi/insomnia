export function metricNumber(value, type = "normal", decimals = 2) {
    if (type === "reverse") {
...
function normalizeLocalizedNumberString(input) {
...
function reverseMetricNumber(value) {
    ...
    // prettier-ignore
    const normalizedUnit = unit.startsWith("qa") ? "qa" :
